...
function getImportPath(componentName: string): string {
  ...
  const uiComponents = [
    "button", "card", "input", "dialog", "select", "checkbox", "switch", 
    "textarea", "alert", "badge", "separator", "breadcrumb", "sidebar"
  ]
  
  // Hooks go to @/hooks
  const hooks = [
    "use-copy-to-clipboard", "use-mobile", "use-countdown", "use-keyboard-shortcut",
    "use-local-storage", "use-on-mount-effect", "use-on-mount-layout-effect",
    "use-on-unmount-effect", "use-on-window-resize", "use-revalidate",
    "use-state-change-effect", "useCountdown", "useLocalStorage", "useOnMountEffect",
    "useOnMountLayoutEffect", "useOnUnmountEffect", "useOnWindowResize", 
    "useRevalidate", "useStateChangeEffect", "useKeyboardShortcut"
  ]
