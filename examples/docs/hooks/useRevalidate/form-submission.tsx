        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-muted/30 to-muted/50 rounded-lg p-4">
            ...
            <form onSubmit={handleUserSubmit} className="space-y-3">
              <div>
                <Label htmlFor="user-name" className="text-sm">Name</Label>
                <Input
                  id="user-name"
                  value={userForm.name}
          ...
          <div className="bg-gradient-to-r from-muted/30 to-muted/50 rounded-lg p-4">
            ...
            <form onSubmit={handlePostSubmit} className="space-y-3">
              <div>
                <Label htmlFor="post-title" className="text-sm">Title</Label>
                <Input
                  id="post-title"
                  ...
                  <div key={index} className="border rounded-lg p-3 bg-muted/50">
                    ...
                    <div className="text-sm mb-2">
                      {submission.type === 'User Created' ? (
                        <div>
                          <strong>Name:</strong> {submission.data.name}<br/>
                          <strong>Email:</strong> {submission.data.email}
                        </div>
                      ) : (
                        <div>
                          <strong>Title:</strong> {submission.data.title}<br/>
                          <strong>Content:</strong> {submission.data.content.substring(0, 50)}...
                        </div>
                      )}
                    </div>
