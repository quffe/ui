...
export default function ViewportBasedEffectsExample() {
  ...
  const getCategoryColor = () => {
    switch (viewportInfo.category) {
      ...
      default:
        return "text-secondary bg-green-900/10"
    }
  }
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-r from-muted/30 to-muted/50 rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div className="bg-card rounded p-3 text-center">
                <div className="flex items-center justify-center mb-2">{getDeviceIcon()}</div>
          ...
          <div className={viewportClass}>
            <div className={getContentStyles()}>
              <h3 className="font-semibold mb-3 text-center">Viewport-Aware Content Layout</h3>
          ...
          <div className="bg-card border rounded-lg p-4">
            ...
            <div className="mt-3 text-xs text-muted-foreground">
              These classes are dynamically applied based on viewport analysis and can be used for
              CSS styling or JavaScript logic.
            </div>
          </div>
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <ul className="mt-1 space-y-1 text-muted-foreground">
                  <li>
                    • <span className="text-secondary">Wide Screen</span>: Ratio {">"} 1.5 (16:9
                    monitors, ultrawide displays)
                  </li>
                  <li>
                    • <span className="text-secondary-foreground">Tall Screen</span>: Ratio {"<"}{" "}
                    0.8 (mobile portrait, vertical monitors)
                  </li>
                  <li>
                    • <span className="text-secondary">Standard Screen</span>: 0.8 ≤ Ratio ≤ 1.5
                    (most tablets, square displays)
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="mt-1 space-y-1 text-muted-foreground">
                  <li>
                    • <span className="text-muted-foreground">Mobile</span>: Width {"<"} 768px
                  </li>
                  <li>
                    • <span className="text-foreground">Tablet</span>: 768px {"≤"} Width {"<"}{" "}
                    1024px
                  </li>
                  <li>
                    • <span className="text-secondary">Desktop</span>: Width {"≥"} 1024px
                  </li>
                </ul>
              </div>
            </div>
