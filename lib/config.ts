...
const getRegistryUrl = () => {
  ...
  return process.env.NEXT_PUBLIC_REGISTRY_URL || process.env.REGISTRY_URL || 'http://localhost:3001/api/registry'
}
...
export const config = {
  ...
  site: {
    ...
    description: process.env.NEXT_PUBLIC_SITE_DESCRIPTION || 'A comprehensive collection of reusable UI components',
  },
